...
<div style="display:flex; align-items:center; flex-direction: column; width: 100wv">
    ...
    <h1 style="margin-bottom: 0; text-align: center"><?php echo i18n("thisis")?></h1>
    <div style="font-size: .75em; color: #3b3b3b; text-align: center">
        <?php echo i18n("project_shorthand_descr", '<img src="/public/images/itunes.png" width="24px" style="margin: 0 .2em; vertical-align: bottom;" />')?>
    </div>
    <br/>
